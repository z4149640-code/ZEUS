            ...
            <div className="flex items-center justify-between border-b border-white/10 px-5 py-4">
              <div className="flex items-center gap-3">
                ...
                <span className="font-display text-lg font-bold uppercase tracking-[0.2em] text-white">
                  {isCheckoutMode ? "إتمام الطلب" : "عربة التسوق"}
                </span>
              </div>
              <button
                onClick={closeCart}
              ...
              <div className="border-t border-white/10 px-5 py-5">
                ...
                {isCheckoutMode ? (
                  ...
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-2 bg-white py-4 font-display text-sm font-bold uppercase tracking-[0.15em] text-black transition-all hover:bg-white/80"
                  >
                    إتمام الطلب
                  </button>
                )}
